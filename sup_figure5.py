"""Supplementary Figure 5: Storage potential and gas fields map."""
...
from config import DSA_PIPELINE, EOR_PIPELINE, NE_ADMIN0, NE_ADMIN1, chart_path, manuscript_font_bundle
...
plot_storage_potential_and_gas_fields(
    ...
    output_path=chart_path("storage_gas_map.png"),
)
