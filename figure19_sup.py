"""
Figure 19 Supplementary: Sensitivity Analysis - Fault Lambda Distance
Multi-panel maps showing seismic risk factor at different fault distance thresholds.
"""
    ...
    if colorbar == 1:
        ...
        for r in range(nrows):
            ...
            style_srf_colorbar(
                fig,
                cbar,
                fontsize_tick=round(mf["colorbar_tick"] * 1.0, 1),
                add_label=False,
            )
            cbars.append(cbar)
        add_shared_ssi_colorbar_label(
...
plot_china_score_traces_multiple(
    csv_path1="./data/Risk_Assessment/sensitivity_fault_lambda_50_risk.csv",
    csv_path2="./data/Risk_Assessment/sensitivity_fault_lambda_100_risk.csv",
    csv_path3="./data/Risk_Assessment/sensitivity_fault_lambda_300_risk.csv",
    csv_path4="./data/Risk_Assessment/sensitivity_fault_lambda_500_risk.csv",
    admin0_path=str(NE_ADMIN0),
    admin1_path=str(NE_ADMIN1),
    output_path=chart_path("sensitivity_fault_lambda_2.png"),
    ncols=2,
    colorbar=2,
)
